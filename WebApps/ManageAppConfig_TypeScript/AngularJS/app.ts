...
declare var ManageAppConfig_Typescript: any;

(function () {

    var ApiPath: string = ManageAppConfig_Typescript.ApiPath;
    var TitleTag: string = ManageAppConfig_Typescript.TitleTag;
