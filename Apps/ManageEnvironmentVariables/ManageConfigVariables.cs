...
namespace ManageConfigVariables
{
    public class ManageConfigVariables
    {
        ...
        private ManageAppConfigVariables appConfigProcessor { get; set; }
        private ManageEnvironmentVariables enVarProcessor { get; set; }
        ...
        {
            string text = "Action to perform. |{add-allenvars|remove-allenvars|list-envars|add-envar|remove-envar|get-envalue|add-allappconfig|remove-allappconfig|list-appconfig|add-appconfig|remove-appconfig|get-appconfigvalue}";
            ...
            var additionalOpts = new OptionSet()
                {
                    ...
                    {
                        //"action|a=", "Action to perform. {add-allenvars|remove-allenvars|list-envars|add-envar|remove-envar|get-envalue|add-allappconfig|remove-allappconfig|list-appconfig|add-appconfig|remove-appconfig|get-appconfigvalue}";, v =>
                        "action|a=", text, v =>
                        {
        ...
        {
            // Don't want to initialize here 
            //  - or - add option with filepath
            appConfigProcessor = new ManageAppConfigVariables();
            // Don't want to initialize here 
            //  - or - add option with filepath
            enVarProcessor = new ManageEnvironmentVariables();
