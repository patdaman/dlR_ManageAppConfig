// <copyright file="Log4NetHelper.cs" company="Signal Genetics Inc.">
...
namespace CommonUtils.Logging
{
    ...
    {
        public static BiDictionary<string, System.Net.Mail.MailPriority> MailPriorityBiDictionary = new BiDictionary<string, System.Net.Mail.MailPriority>()
        {
        ...
        public static BiDictionary<String, RSysFac> SyslogFacilityBiDictionary = new BiDictionary<string, RSysFac>()
        {
